...
; Pallet Town events
	...
	const EVENT_COMPLETED_POKEDEX_EPILOGUE
...
; Viridian City events
	...
	const EVENT_BEAT_VIRIDIAN_OLD_MAN
	const_skip 13
...
; Lavender Town events
	...
	const EVENT_BEAT_LAVENDER_WHITE_HAND
	const_skip 15
...
; Celadon City events
	...
	const EVENT_BEAT_CELADON_CHIEF
	const EVENT_FOUND_CELADON_LEDGER
	const_skip 5
	const EVENT_1B8 ; ???
...
; Fuchsia City events
	...
	const EVENT_ERIK_ASKED_TO_FIND_SARA
	const EVENT_REUNITED_ERIK_AND_SARA
	const EVENT_FUCHSIA_RHYHORN_ESCAPED
	const EVENT_SAW_FUCHSIA_RHYHORN_ESCAPE
	const EVENT_BEAT_FUCHSIA_ESCAPED_RHYHORN
	const_skip
	const EVENT_STARTED_SAFARI_MASTER_CHALLENGE
	const EVENT_SAFARI_MASTER_CAUGHT_CHANSEY
	const EVENT_SAFARI_MASTER_CAUGHT_KANGASKHAN
	const EVENT_SAFARI_MASTER_CAUGHT_TAUROS
	const EVENT_SAFARI_MASTER_CAUGHT_SCYTHER_OR_PINSIR
	const EVENT_BECAME_SAFARI_MASTER
	const_skip 8
...
; Saffron City events
	...
	const EVENT_BEAT_COPYCAT
	const EVENT_STARTED_PIDGEY_DELIVERY
	const EVENT_FOUND_PIDGEY_LETTER
	const EVENT_DELIVERED_PIDGEY_LETTER
	const EVENT_REUNITED_COURIER_PIDGEY
	const EVENT_GOT_PIDGEY_DELIVERY_PP_UP
	const_skip 9
...
; Route 8 events
	const_next $430
	const EVENT_HEARD_UNDERGROUND_PATH_PHANTOM_TRAIN
	...
	const EVENT_BEAT_UNDERGROUND_PATH_ROCKET_DESERTER
...
; Route 10 events
	...
	const EVENT_RESTORED_POWER_PLANT
...
; Route 23 events
	...
	const EVENT_BEAT_ROUTE_23_SHORTS_YOUNGSTER
...
; Route 24 events
	...
	const EVENT_SAW_BILLS_GARDEN_PIKACHU_SKIM
...
; Route 25 events
	...
	const EVENT_UNLOCKED_BILLS_SECRET_GARDEN
...
; Viridian Forest events
	const_next $560
	const EVENT_HEARD_VIRIDIAN_FOREST_RUSTLE
	const_skip
...
; Mt. Moon events
	const_next $570
	const EVENT_COMPLETED_MT_MOON_MOONFALL_CEREMONY
	...
	const EVENT_HEARD_MT_MOON_MOONFALL_RUMBLE
...
; S.S. Anne events
	...
	const EVENT_MOVED_VERMILION_DOCK_TRUCK
	const EVENT_BEAT_VERMILION_DOCK_MEW
	const EVENT_SAW_SS_ANNE_SEA_SHADOW
	const EVENT_BEAT_VERMILION_DOCK_GHOST_SAILOR
	const_skip 7
...
; Pokémon Mansion events
	...
	const EVENT_BEAT_MANSION_DITTO
	const_skip 14
...
; Seafoam Islands events
	...
	const EVENT_BEAT_SEAFOAM_WHIRLPOOL_GYARADOS
	const_skip 7
