...
; wDamageMultipliers
DEF BIT_NOT_VERY_EFFECTIVE EQU 0
DEF BIT_SUPER_EFFECTIVE EQU 1
DEF BIT_STAB_DAMAGE EQU 7
DEF EFFECTIVENESS_MASK EQU %01111111
DEF CANCELLED_EFFECTIVENESS EQU (1 << BIT_NOT_VERY_EFFECTIVE) | (1 << BIT_SUPER_EFFECTIVE)
DEF TYPE_IMMUNITY EQU EFFECTIVENESS_MASK
