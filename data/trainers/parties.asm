...
CopycatData:
	db TRAINER_LEVEL_MATCH_PLAYER, DITTO, 0
...
; Cerulean City
	db $FF, 18, PIDGEOTTO, 15, ABRA, 16, RATTATA, 18, WARTORTLE, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 16, RATTATA, 18, IVYSAUR, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 16, RATTATA, 18, CHARMELEON, 0

ProfOakData:
; Oak's Lab, chosen according to the player's starter
; Bulbasaur: Oak kept Squirtle
	db $FF, 66, PORYGON, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, BLASTOISE, 70, GYARADOS, 0
; Charmander: Oak kept Bulbasaur
	db $FF, 66, PORYGON, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, VENUSAUR, 70, GYARADOS, 0
; Squirtle: Oak kept Charmander
	db $FF, 66, PORYGON, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, CHARIZARD, 70, GYARADOS, 0
ProfOakDataEnd:
...
BrunoData:
	db $FF, 55, ONIX, 56, HITMONCHAN, 56, HITMONLEE, 57, PRIMEAPE, 60, MACHAMP, 0
BrunoDataEnd:
	assert BrunoDataEnd - BrunoData == 2 + ELITE_FOUR_PARTY_LENGTH * 2
...
Rival2Data:
; SS Anne 2F
	db $FF, 20, PIDGEOTTO, 19, RATICATE, 20, KADABRA, 22, WARTORTLE, 0
	db $FF, 20, PIDGEOTTO, 19, RATICATE, 20, KADABRA, 22, IVYSAUR, 0
	db $FF, 20, PIDGEOTTO, 19, RATICATE, 20, KADABRA, 22, CHARMELEON, 0
; Pokémon Tower 2F
	db $FF, 27, PIDGEOTTO, 25, GROWLITHE, 25, EXEGGCUTE, 27, KADABRA, 29, WARTORTLE, 0
	db $FF, 27, PIDGEOTTO, 25, GYARADOS, 25, GROWLITHE, 27, KADABRA, 29, IVYSAUR, 0
	db $FF, 27, PIDGEOTTO, 25, EXEGGCUTE, 25, GYARADOS, 27, KADABRA, 29, CHARMELEON, 0
; Silph Co. 7F
	db $FF, 38, PIDGEOT, 36, RHYHORN, 37, GROWLITHE, 37, EXEGGCUTE, 39, ALAKAZAM, 42, BLASTOISE, 0
	db $FF, 38, PIDGEOT, 36, RHYHORN, 37, GYARADOS, 37, GROWLITHE, 39, ALAKAZAM, 42, VENUSAUR, 0
	db $FF, 38, PIDGEOT, 36, RHYHORN, 37, EXEGGCUTE, 37, GYARADOS, 39, ALAKAZAM, 42, CHARIZARD, 0
; Route 22
...
Rival3Data:
	db $FF, 61, PIDGEOT, 60, ALAKAZAM, 61, RHYDON, 62, ARCANINE, 63, EXEGGUTOR, 65, BLASTOISE, 0
	db $FF, 61, PIDGEOT, 60, ALAKAZAM, 61, RHYDON, 62, GYARADOS, 63, ARCANINE, 65, VENUSAUR, 0
	db $FF, 61, PIDGEOT, 60, ALAKAZAM, 61, RHYDON, 62, EXEGGUTOR, 63, GYARADOS, 65, CHARIZARD, 0
	; Postgame training in Viridian Gym
	db $FF, 63, PIDGEOT, 63, ALAKAZAM, 64, RHYDON, 65, GYARADOS, 66, EXEGGUTOR, 67, ARCANINE, 0
Rival3DataEnd:
	assert Rival3DataEnd - Rival3Data == NUM_RIVAL3_TEAMS * (2 + PARTY_LENGTH * 2)

LoreleiData:
	db $FF, 54, DEWGONG, 54, CLOYSTER, 55, SLOWBRO, 56, JYNX, 58, LAPRAS, 0
LoreleiDataEnd:
	assert LoreleiDataEnd - LoreleiData == 2 + ELITE_FOUR_PARTY_LENGTH * 2
...
AgathaData:
	db $FF, 57, GENGAR, 57, GOLBAT, 58, HAUNTER, 59, ARBOK, 61, GENGAR, 0
AgathaDataEnd:
	assert AgathaDataEnd - AgathaData == 2 + ELITE_FOUR_PARTY_LENGTH * 2

LanceData:
	db $FF, 58, GYARADOS, 59, DRAGONAIR, 59, DRAGONAIR, 61, AERODACTYL, 63, DRAGONITE, 0
LanceDataEnd:
	assert LanceDataEnd - LanceData == 2 + ELITE_FOUR_PARTY_LENGTH * 2
