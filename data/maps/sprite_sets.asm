...
MapSpriteSets:
	...
	db SPRITESET_ROUTE_25_WANDERER ; ROUTE_25
...
; SPRITESET_BILLS_GARDEN
	...
	db SPRITE_SWIMMER
	db SPRITE_YOUNGSTER
	db SPRITE_GARDEN_TABLE
	db SPRITE_GARDEN_CHAIR

; SPRITESET_ROUTE_25_WANDERER
	db SPRITE_YOUNGSTER
	db SPRITE_WANDERER
	db SPRITE_SUPER_NERD
	db SPRITE_HIKER
