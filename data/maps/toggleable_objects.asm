...
SupplementalToggleableObjectStates:
	...
	db REDS_HOUSE_2F,       REDSHOUSE2F_DIPLOMA,          ON
	db ROUTE_23,            ROUTE23_SHORTS_YOUNGSTER,     ON
	db ROUTE_20,            ROUTE20_VISITING_ARTICUNO,    ON
