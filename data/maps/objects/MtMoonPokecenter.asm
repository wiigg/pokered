	...
	const_export MTMOONPOKECENTER_WANDERER
...
MtMoonPokecenter_Object:
	...
	object_event 10,  6, SPRITE_MIDDLE_AGED_MAN, WALK, LEFT_RIGHT, TEXT_MTMOONPOKECENTER_MAGIKARP_SALESMAN, OPP_FISHER, 12
	...
	object_event 12,  4, SPRITE_WANDERER, STAY, LEFT, TEXT_MTMOONPOKECENTER_WANDERER
