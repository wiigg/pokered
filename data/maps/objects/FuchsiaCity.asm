	...
	const_export FUCHSIACITY_SARA
	const_export FUCHSIACITY_ESCAPED_RHYHORN
	const_export FUCHSIACITY_CHASING_WARDEN
...
FuchsiaCity_Object:
	...
	object_event 29, 14, SPRITE_GIRL, STAY, RIGHT, TEXT_FUCHSIACITY_SARA
	object_event 18, 10, SPRITE_MONSTER, STAY, DOWN, TEXT_FUCHSIACITY_ESCAPED_RHYHORN
	object_event 18,  8, SPRITE_WARDEN, STAY, DOWN, TEXT_FUCHSIACITY_CHASING_WARDEN
