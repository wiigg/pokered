	...
	const_export ROUTE12_REFORMED_FISHER
	const_export ROUTE12_RATICATE
...
Route12_Object:
	...
	object_event 13, 72, SPRITE_FISHER, STAY, UP, TEXT_ROUTE12_REFORMED_FISHER
	object_event 12, 72, SPRITE_MONSTER, STAY, DOWN, TEXT_ROUTE12_RATICATE
